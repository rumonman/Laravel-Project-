                   ...
                   <form action="{{route('questions.update', $question->id)}}" method="post">
                    @method('PUT')
                   	...
                   	<div class="form-group">
                   		...
                   		<input value="{{old('title',$question->title)}}" class="form-control {{ $errors->has('title') ? ' is-invalid' : '' }}" type="text" id="question_title" name="title">
                   		@if ($errors->has('title'))
                     ...
                     <div class="form-group">
                   		<button type="submit" class="btn btn-outline-primary btn-sm">Update This Question</button> 
                    	</div>
